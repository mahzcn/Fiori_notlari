...
git rm hello.py
```
komutunu kullanıyoruz. Daha sonra git deposuna silme işlemini bildirmek için tekrar **commit** işlemi uyguluyoruz. İşlemleri gerçekleştirdikten sonra **git status** komutunu yazarak her şeyin yolunda olduğunu 
